    ...
    <form>
      <div class="input_wrap">
        <label for="register_id">
          <span
            class="wait"
            :class="{checked:registerFinally.id}"
          />身分證字號
        </label>
        <input
          id="register_id"
          ...
          @blur="checkId"
        >
        <span ref="ruleCode_id" />
      </div>
      <div class="input_wrap">
        <label for="register_name">
          <span
            class="wait"
            :class="{checked:registerFinally.name}"
          />姓名
        </label>
        <input
          id="register_name"
          ...
          @blur="checkName"
        >
        <span ref="ruleCode_name" />
      </div>
      <div
        ref="gender"
        class="input_wrap input_gender"
      >
        <p>性別</p>
        <div class="radio_wrap">
          ...
          <span
            class="wait"
            :class="{checked:registerFinally.gender}"
          />
        </div>
      </div>
      <div class="input_wrap">
        <label for="register_phoneNum">
          <span
            class="wait"
            :class="{checked:registerFinally.phoneNum}"
          />手機號碼
        </label>
        <input
...
export default {
  ...
  methods: {
    ...
    checkGender (el) {
      const vm = this
      vm.registerFinally.gender = Boolean(vm.inputValue.gender === 1 || 2)
